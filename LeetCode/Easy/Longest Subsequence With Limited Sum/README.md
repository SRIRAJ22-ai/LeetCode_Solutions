...
| **Link** | [View Problem](https://leetcode.com/problems/longest-subsequence-with-limited-sum/) |
| **Runtime** | 4 ms |
| **Memory** | 18.2 MB |
...
**Title**: CPP | Easy | Prefix Sum | Time O(QlogN)
**Author**: [@amirkpatna](https://leetcode.com/amirkpatna/)
**Upvotes**: 17 👍
**Link**: [View Original Post](https://leetcode.com/problems/longest-subsequence-with-limited-sum/solutions/2492714/)

---

**Intuition :** Sort the array and generate prefix sum for `nums` and for each query search for this sum using `binary-search` in your `prefix-sum` array
